...
- Configurable for different MIMIC-IV versions
</div>
<div class="tool-link-container">
...
<h3 class="tool-title">CLIF SQL Boilerplate</h3>
</div>
<div class="tool-description">
Jump-start your CLIF 2.0 implementation with our pre-built SQL queries for Epic's Caboodle/Clarity systems. These carefully crafted queries help you extract and transform your Epic data into the CLIF format efficiently.
...
<i class="fas fa-external-link-alt"></i> Launch Lighthouse
</a>
</div>
</div>

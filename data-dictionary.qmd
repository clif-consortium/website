...
+--------------------+-----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| location_type      | VARCHAR         | Maps `location_name` to a standardized list of ADT location types                                                                                        | `general_icu` (default if unknown & default if its an open ICU)                                                     |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `medical_icu`                                                                                                       |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `surgical_icu`                                                                                                      |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `cardiac_icu` (without surgical patients)                                                                           |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `mixed_cardiac_icu` (includes cardiac surgery patients)                                                             |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `cvicu_icu` (surgical cardiovascular only)                                                                          |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `neuro_icu` (neuro only, without surgery                                                                            |
|                    |                 |                                                                                                                                                          |                                                                                                                     |
|                    |                 |                                                                                                                                                          | `mixed_neuro_icu` (neuro + neurosurgery).                                                                           |
+--------------------+-----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+
| hospital_type      | VARCHAR         | Maps `hospital_id` to a standardized list of hospital types                                                                                              | `academic`, `community`                                                                                             |
+--------------------+-----------------+----------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------+

**Note**: Procedural areas and operating rooms should be mapped to `Procedural`. Pre/Intra/Post-procedural/OR EHR data (such as anesthesia flowsheet records from Labs, Vitals, Scores, Respiratory Support) **are not currently** represented in CLIF. For `location_type`, All `_icu` variables should be used for **closed** ICUs, all open ICUs should be labeled as `general_icu` !

**Example**:

::: scrollable-table
+--------------------+-------------+---------------------+---------------------+---------------+-------------------+
| hospitalization_id | hospital_id | in_dttm             | out_dttm            | location_name | location_category |
+====================+=============+=====================+=====================+===============+===================+
| 20010012           | ABC         | 2024-12-01 10:00:00 | 2024-12-01 14:00:00 | N04E          | icu               |
+--------------------+-------------+---------------------+---------------------+---------------+-------------------+
| 20010012           | ABC         | 2024-12-01 14:30:00 | 2024-12-02 08:00:00 | N05W          | ward              |
+--------------------+-------------+---------------------+---------------------+---------------+-------------------+
| 20010015           | ABC         | 2024-11-30 16:45:00 | 2024-12-01 12:00:00 | N03E          | icu               |
+--------------------+-------------+---------------------+---------------------+---------------+-------------------+
| 20010015           | ABC         | 2024-12-01 12:30:00 | 2024-12-02 07:00:00 | N07S          | procedural        |
+--------------------+-------------+---------------------+---------------------+---------------+-------------------+
| 20010020           | ABC         | 2024-11-28 09:00:00 | 2024-11-29 17:00:00 | N06N          | ward              |
+--------------------+-------------+---------------------+---------------------+---------------+-------------------+

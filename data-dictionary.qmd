...
* For `location_type`, the following ICU types should be used:
	+ `general_icu`: Default if unknown or if it's an open ICU.
...
All `_icu` variables should be used for **closed** ICUs, and all open ICUs should be labeled as `general_icu`.

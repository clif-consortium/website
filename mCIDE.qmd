...
We have constructed a minimum set of Common ICU Data Elements (mCDE) for a CLIF database. CDEs have the following features

1.  represents a precisely defined clinical entity
2.  limited set of permissible values

`*_category` variables are CDEs. Whenever possible, we chose CDEs directly from the [NIH CDE Repository](https://cde.nlm.nih.gov/home).
